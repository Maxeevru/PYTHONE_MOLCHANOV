#Cредствами языка Python сформировать текстовый файл (.txt), содержащий последовательность из целых положительных и отрицательных чисел. Сформировать новый текстовый файл (.txt) следующего вида, предварительно выполнив требуемуюобработку элементов Исходные данные Количество элементов Положительные числа Количество положительных чисел Отрицательные числа Количество отрицательных чисел
